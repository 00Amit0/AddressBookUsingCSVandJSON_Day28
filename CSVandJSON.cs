...
namespace AddressBookUsingCSVandJSON
{
    internal class CSVandJSON
    {
        ...
        {
            string importFilePath = @"D:\RFP\AddressBookUsingCSVandJSON\AddressBookUsingCSVandJSON\TextFile1.txt";
            string exportFilePath = @"D:\RFP\AddressBookUsingCSVandJSON\AddressBookUsingCSVandJSON\WriteAddressBookCSV.csv";
